...
const Wave: React.FC = () => (
	<div className="flex w-full">
		<svg className="w-full h-1/6" viewBox="0 0 1440 206" fill="none">
			<path
				...
				fill="url(#paint0_linear_323_12332)"
			/>
			<path
				...
				fill="url(#paint1_linear_323_12332)"
			/>
			<defs>
				<linearGradient
					id="paint0_linear_323_12332"
					x1="1200.55"
					y1="73.7127"
					x2="1141.6"
					y2="256.683"
